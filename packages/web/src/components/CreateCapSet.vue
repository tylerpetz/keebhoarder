...
.theme-${this.themeName.toLowerCase().split(' ').join('-') || 'demo'} {
  ...
  /* theme backgrounds */
  --theme-bg-h: ${this.hsl.themeBackground[0] || this.hsl.modCaps[0]};
  --theme-bg-s: ${this.hsl.themeBackground[1] || this.hsl.modCaps[1]}%;
  --theme-bg-l: ${this.hsl.themeBackground[2] || (this.hsl.modCaps[2] - 10)}%;

  /* theme text */
  --theme-text-h: ${this.hsl.themeText[0] || this.hsl.modLegends[0]};
  --theme-text-s: ${this.hsl.themeText[1] || this.hsl.modLegends[1]}%;
  --theme-text-l: ${this.hsl.themeText[2] || (this.hsl.modLegends[2] - 10)}%;

  /* theme links/borders */
  --theme-link-h: ${this.hsl.themeLink[0] || this.hsl.accentCaps[0]};
  --theme-link-s: ${this.hsl.themeLink[1] || this.hsl.accentCaps[1]}%;
  --theme-link-l: ${this.hsl.themeLink[2] || (this.hsl.accentCaps[2] - 10)}%;

  /* modify hsl values like a boss */
  --theme-bg: hsl(var(--theme-bg-h), var(--theme-bg-s), var(--theme-bg-l));
  --theme-bg-alt: hsl(var(--theme-bg-h), var(--theme-bg-s), calc(var(--theme-bg-l) * .75));

  --theme-text: hsl(var(--theme-text-h), var(--theme-text-s), var(--theme-text-l));
  --theme-text-alt: hsl(var(--theme-text-h), var(--theme-text-s), calc(var(--theme-text-l) * .75));

  --theme-link: hsl(var(--theme-link-h), var(--theme-link-s), var(--theme-link-l));
  --theme-link-hover: hsl(var(--theme-link-h), var(--theme-link-s), calc(var(--theme-link-l) * .75));
