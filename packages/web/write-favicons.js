 ...
 * @return {Array}
*/
const removeUnneededRules = rules => rules.filter(rule => rule.selectors && rule.selectors[0].includes('.theme-'))
const removeUnneededDeclarations = declarations => declarations.filter(declaration => declaration.property && (declaration.property.includes('--accent-legend') || declaration.property.includes('--accent-cap')))
...
>
  ...
  <path fill="${theme[themeName].foregroundS}" d="M14.145 13.1625C14.3817 13.4123 14.5 13.6839 14.5 13.9772C14.5 14.2813 14.3868 14.5475 14.1605 14.7756C13.9444 15.0037 13.6924 15.1178 13.4043 15.1178C13.0751 15.1178 12.7819 14.9766 12.5247 14.6941L7.74072 9.75698V13.8957C7.74072 14.2868 7.6327 14.5964 7.41665 14.8245C7.2006 15.0526 6.90739 15.1667 6.53702 15.1667C6.16665 15.1667 5.87344 15.0526 5.65739 14.8245C5.44134 14.5964 5.33331 14.2868 5.33331 13.8957V4.75466C5.33331 4.37446 5.44134 4.0703 5.65739 3.84218C5.87344 3.61406 6.16665 3.5 6.53702 3.5C6.90739 3.5 7.2006 3.61406 7.41665 3.84218C7.6327 4.0703 7.74072 4.37446 7.74072 4.75466V8.64898L12.4012 3.87477C12.6276 3.63579 12.8848 3.51629 13.1728 3.51629C13.4609 3.51629 13.7129 3.63035 13.929 3.85847C14.145 4.07573 14.2531 4.33644 14.2531 4.6406C14.2531 4.95562 14.1296 5.23805 13.8827 5.4879L10.2099 9.12151L14.145 13.1625Z" />
...
const writeFaviconstoFile = (favicons) => {
  favicons.forEach((favicon) => {
    const filename = `public/favicon-${Object.keys(favicon)[0]}.svg`
