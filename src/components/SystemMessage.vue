      ...
      >
        <div class="p-4">
          <div class="flex items-start">
            <div
              class="flex-shrink-0 "
              :class="{ 'text-green-400': message.type === 'success', 'text-red-600': message.type === 'error', 'hidden': !message.type}"
            >
              <svg
            ...
            <div class="ml-3 w-0 flex-1 pt-0.5">
              ...
              <p
                v-if="message.text"
                class="mt-1 text-sm text-theme-text-d"
              >
                {{ message.text }}
              </p>
            </div>
            <div class="ml-4 flex-shrink-0 flex">
              <button
                class="bg-transparent rounded-md inline-flex text-theme-text hover:text-theme-text-l focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-theme-border"
